...
def generate_writeup(stats: dict) -> str:
    ...
    lines = [
        ...
        f"  lower success rate. There is no scenario where it outperforms rush at beach.",
        "",
        "---",
        "",
    ...
    lines += [
        ...
        f"             ocean castDist = {CAST_DISTANCE};  river castDist = {RIVER_CAST_DISTANCE}",
        "```",
        ...
        f"Starting XP: {int(_fish_xp('Sunfish', 0, True))} from Sunfish at farm pond (Training Rod → always normal quality).",
        "",
